    ...
    <header className="w-full bg-white relative z-50">
      <div className="bg-bg-grey text-primary-white py-2 px-4 md:px-12 flex justify-between items-center text-[10px] md:text-xs">
        ...
        <span className="hidden md:inline">
          زعفران اصل هرات | تضمین کیفیت و اصالت
        </span>
      </div>
        ...
        <div className="flex md:hidden items-center gap-2">
          <Sheet>
            ...
            <SheetContent side="right" className="w-full bg-white">
              ...
              <nav className="flex flex-col gap-4 mt-12 text-right pr-6">
                {NAV_LINKS.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
              ...
              <div className="flex items-center justify-end pr-6 gap-6 ">
                <div className="flex items-center gap-3" dir="ltr">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[12px] font-normal text-text-2 text-right">
                      پاسخگویی ۹ تا ۴
                    </p>
                  </div>
                </div>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      variant="outline"
                      size="sm"
                      className="gap-5 border-grey-50 text-text-2"
                    >
        ...
        <div className="container mx-auto px-4 flex justify-end">
          <ul className="flex items-center gap-8">
            ...
            <li className="flex items-center gap-2 text-text-2 font-normal text-sm  pr-6 ">
             ...
             <Link href='#categories'> دسته بندی محصولات</Link>
              <Image
